...
# The "outside a repository" assertion below used to be wrapped in a guard
# that skipped it whenever Vim's own temporary directory happened to sit
# inside a Git checkout, which reports a hole in the suite as a pass.
# tests/fixture.vim picks a repository-free base instead - and removes it
# however this run ends, a base of its own choosing being one nobody else
# cleans up.
